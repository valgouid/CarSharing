...
$message .= "https://travelcarsharing.000webhostapp.com/resetpassword.php?user_id=$user_id&key=$key";
if(mail($email, 'Reset your password', $message, 'From:'.'itsvalv@gmail.com')){
